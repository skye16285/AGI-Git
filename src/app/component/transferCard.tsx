...
export default function TransferCard(props: any) {
  ...
  return (
    <>
      <Card
        className="rounded-lg text-card-foreground shadow-sm w-full bg-opacity-10 bg-white backdrop-blur-lg border-0 mx-5 mb-5 h-243 w-1/3 rounded-[20px] bg-[#404040] fade-animation"
        shadow="sm"
        isPressable
      >
